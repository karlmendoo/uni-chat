...
export function UniversitySelect({ value, onChange, className }: UniversitySelectProps) {
  ...
  return (
    <div className={cn('relative', className)} ref={dropdownRef}>
      ...
      >
        <span className={selectedUniversity ? 'text-white' : 'text-slate-400'}>
          ...
          <div className="p-3 border-b border-white/10">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white/5 rounded-lg border border-white/10 focus:outline-none focus:ring-2 focus:ring-primary/50 text-white placeholder:text-slate-400"
                autoFocus
              />
            </div>
          </div>
            ...
            {filteredUniversities.length > 0 ? (
              filteredUniversities.map((uni) => (
                ...
                >
                  ...
                  <div className="text-sm text-slate-400">{uni.country}</div>
                </button>
              ))
            ) : (
